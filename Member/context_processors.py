...
def pending_requests_count(request):
    ...
    try:
        ...
        if "admin" in user:
            ...
            pending_joining_requests = Notification.objects.filter(notification_type='join_request', club=club)
            pending_event_requests = Notification.objects.filter(notification_type='events', club=club)
